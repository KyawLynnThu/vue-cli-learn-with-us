...
<div class="row confirm">
  <div class="col-lg-4 col-md-6 col-12 mx-auto">
    ...
    <form class="bg-light p-4">
      ...
      <div class="mb-3 mt-4">
        <router-link @click="confirm" :to="{ name: 'LogIn' }" type="submit" class="btn btn-dark btn-block text-uppercase font-weight-bold">
          CONFIRM
        </router-link>
      </div>
      <div>
        <router-link @click="confirm" :to="{ name: 'SignUp' }" type="submit" class="
