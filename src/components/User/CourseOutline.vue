...
<div class="row mt-4 pl-md-5">
  <div class="col-md-7">
    <div v-if="purchase==false">
      <iframe width="100%" height="450" :src="defaultVideolink" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <div v-if="purchase==true">
      <iframe width="100%" height="450" :src="videoPath" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    ...
    <div class="pb-3">
      <span v-if="courseData.price == 0" class="vd-desc bg-dark text-white p-2 text-center rounded d-inline-block">Free</span>
  ...
  <div class="col-md-5 pr-md-5 mt-4 mt-md-0">
    ...
    <div v-if="purchase==false">
     ...
     <div v-if="purchase==true">
      <div v-for="(videos, index) in courseData.video" :key="index">
        <button class="course-btn bg-secondary text-white p-3 mb-1 d-block w-100 text-left" @click.prevent="changePath(index)">
          CHAPTER {{ index+1 }}
        </button>
      </div>
    </div>
